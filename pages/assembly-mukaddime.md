...
Başta anlattığımız, devrenin bir durumunun benzersiz bir numara ile ilişkisinin olmasıyla benzersiz numaranın da yine aynı şekilde bir kelimeye karşılık gelmesi ilişkilerini biraz daha açmam bu noktada çok anlamlı olacaktır. Devre durumu-benzersiz numara ilişkisinde bir farklılık yok. Ancak benzersiz numara ve kelime ilişkisini kurarken işlemcinin aynı anda kaç bitlik data-yı işleyebileceğini düşünerek ve bu kapasitesiyle en fazla ne kadarlık bir numara veya numaralar dizisini alabilir bunu da düşünmemiz gerekiyor. Sözgelimi mesela 8-bitlik bir işlemci için düşünecek olursak aynı anda tek bir ​​cycle​-da 8-bitten oluşan “instruction” yani numara veya numaralar dizisi alabilir, işleyebilir.Şuana kadar hep numara veya numaralar diye bahsettiğimiz​ ve binary format/bytecode ile gösterdiğimi bu kodların literatürdeki ismi "opcode" ​olarak geçer.Binary format isminden de anlaşılacağı ve yukarıda da bahsettiğimiz üzere buradaki “data”nın ikilik tabanda ifade edilmesinden dolayı kullanılan bir isim. Bytecode ise daha çok bu binary ifadelerin 8 ile bölündüğünde elde edilecek sayının birim olarak byte olması ve bu şekilde gruplandırılması dışında bir farklılık arz etmez.Tabi diğer taraftan bunlar tamamen matematiksel ve soyut birer gösterim olduğundan binary şeklinde ifade edilebilir olduğu gibi ayrıca onaltılık ve onluk tabanda da ifade edilebilir veya gösterilebilir.Bu seçim ve gösterim tamamen soyut olmakla beraber ifadenin anlaşılması, kısa gösterilebilmesi (okunabilirlik) ve standart oluşturmada kolaylık sağlaması durumlarına bağlı eğişiklik gösterebilir. Ama bunun devreyle veya günün sonunda CPU'nun 0-1 birden anlayacağı gerçeğini değiştirmediği de ortadadır. 
